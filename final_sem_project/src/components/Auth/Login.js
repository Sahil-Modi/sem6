...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      setError('');
      setLoading(true);
      // Default to donor role for Google login, can be changed in profile
      ...
      <div className="relative max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02]">
          ...
          <div className="px-8 py-10">
            ...
            <p className="text-gray-600 text-center mb-8">Sign in to continue saving lives</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-primary-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-primary-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
            ...
            <div className="mt-6">
              ...
              <button
                ...
                disabled={loading}
                className="mt-4 w-full flex items-center justify-center px-4 py-3 border-2 border-gray-300 rounded-lg hover:bg-gray-50 hover:border-primary-300 transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50"
              >
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                ...
                <Link to="/register" className="text-primary-600 font-bold hover:text-primary-700 hover:underline transition">
                  Create Account
                </Link>
              </p>
            </div>
